  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className='relative mx-auto pt-2 text-gray-600'>
        <input
          className='h-10 rounded-lg border-2 border-gray-300 bg-gray-100 px-5 pr-16 text-sm focus-within:outline-none focus:border-mainColor focus:outline-none focus-visible:outline-none'
          type='search'
          name='search'
          placeholder='Search'
        />
